...
#    "sw/coremark_text.dat"
#    "sw/coremark_data.dat"
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/rtl/miriscv_mem_req_stage.sv"]"\
 "[file normalize "$origin_dir/rtl/miriscv_mem_data_stage.sv"]"\
 ...
 "[file normalize "$origin_dir/sw/coremark_text.dat"]"\
 "[file normalize "$origin_dir/sw/coremark_data.dat"]"\
 "[file normalize "$origin_dir/xdc/miriscv_test_soc.xdc"]"\
 "[file normalize "$origin_dir/tb/tb_miriscv_coremark.sv"]"\
  ]
  foreach ifile $files {
...
set file "$origin_dir/rtl/miriscv_mem_req_stage.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/rtl/miriscv_mem_data_stage.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set file "$origin_dir/sw/coremark_text.dat"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Data Files" -objects $file_obj

set file "$origin_dir/sw/coremark_data.dat"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Data Files" -objects $file_obj
...
set file "$origin_dir/tb/tb_miriscv_coremark.sv"
set file [file normalize $file]
...
set_property -name "top" -value "tb_miriscv_coremark" -objects $obj
